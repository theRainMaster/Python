...
'''
listnew = list_a[start:end] - извлечение всех элементов
от индекса start(включительно) до индекса end(не включительно) в новый список
'''
print(s[0:2])   # Срез включает первые 2 символа - 'Py'
print(s[2:-2])  # С 3 по предпоследний символ - 'th' [2:4]
...
''' Применение срезов для изменения списков 
Команда вида list_a[index1:index2] = list_b
заменяет все элементы lista между index1 и index2 элементами из list_b '''
L = ["А", "В", "С", "D", "Е", "F"]
#L[2:2] = ["X", "Y"]  # ['А', 'В', 'X', 'Y', 'С', 'D', 'Е', 'F']
#L[2:3] = ["X", "Y"]  # ['А', 'В', 'X', 'Y', 'D', 'Е', 'F']
#L[2:5] = ["X", "Y"]  # Что будет?
L[len(L):] = [1, 2, 3]  # присоединяет к концу списка
L[:0] = [10, 9, 8]  # присоединяет к началу списка
L[2:4] = [] # удаляет указанные элементы из списка
print(L)
...
print(aircraft [SEATING] [MAXIMUM]) # aircraft[2][1]
